                        ...
                        <nav class="navbar navbar-expand-lg navbar-light">
                            ...
                            <div class="collapse navbar-collapse" id="navbarNav">
                                <ul class="navbar-nav flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-7" aria-controls="submenu-5"><i class="fas fa-fw fa-table"></i>Quản lý sản phẩm biến thể</a>
                                        <div id="submenu-7" class="collapse submenu" style="">
                                            <ul class="nav flex-column">
                                                <li class="nav-item">
                                                    <a class="nav-link" href="/admin/skus">Danh sách sản phẩm biến thể</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" href="/admin/skus/create">Thêm sản phẩm biến thể</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </li>
