        ...
        <div class="dashboard-wrapper">
            <div class="container-fluid dashboard-content">
                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active mt-2" aria-current="page"><a href="/admin/categories" class="link">Danh sách loại sản phẩm</a></li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h3 class="card-title custom-title">Danh sách loại sản phẩm</h3>
                            <?php
                            if (count($data)) :
                            ?>
