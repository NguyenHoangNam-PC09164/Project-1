                ...
                <?php else: ?>
                    <table class="table table-bordered table-hover shop-cart text-center">
                        ...
                        <tbody>
                            <?php foreach ($cart as $id => $item): ?>
                                <tr>
                                    <td><img src="<?= APP_URL ?>/public/uploads/products/<?= $item['image'] ?>" alt="<?= $item['name'] ?>" class="product-image"></td>
                                    <td><?= $item['name'] ?></td>
                                    <td>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-md-offset-6">
                            <table class="table">
                                <tr>
                                    <th class="text-right"><h3>Tổng cộng:</h3></th>
                                    <td class="text-right"><h3><?= number_format($total, 0, ',', '.') ?> VND</h3></td>
                                </tr>
                            </table>
